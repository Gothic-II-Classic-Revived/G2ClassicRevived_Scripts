...
INSTANCE ABM_Day_Fgt	(C_MUSICTHEME_FIGHT)		{	file			= "Dungeon_Fight.mp3";	};

// Free Mine
INSTANCE FRM_Day_Std	(C_MUSICTHEME_STANDARD)		{	file			= "OldMine.mp3";		};
INSTANCE FRM_Day_Fgt	(C_MUSICTHEME_FIGHT)		{	file			= "Dungeon_Fight.mp3";	};

// Old Mine
INSTANCE OLM_Day_Std	(C_MUSICTHEME_STANDARD)		{	file			= "OldMine.mp3";		};
INSTANCE OLM_Day_Fgt	(C_MUSICTHEME_FIGHT)		{	file			= "Dungeon_Fight.mp3";	};
...
INSTANCE TPL_Day_Fgt	(C_MUSICTHEME_FIGHT)		{	file			= "Dungeon_Fight.mp3";	};
