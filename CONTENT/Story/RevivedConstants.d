...
const string NAME_PsiNovice				=	"Apocalyptic Novice";
...
const int Face_P_Hum_TattooMad1 = 8;
const int Face_P_Hum_Bald1      = 9;
const int Face_P_Hum_Bald2      = 10;
const int Face_P_Hum_Bald3      = 11;
const int Face_P_Hum_Bald4      = 12;
const int Face_P_Hum_Bald5      = 13;
const int Face_P_Hum_Beard1     = 14;
const int Face_P_Hum_Beard2     = 15;
const int Face_P_Hum_BeardOld1  = 16;
const int Face_P_Albrecht       = 17;
const int Face_P_Alwin          = 18;
const int Face_P_Balthasar      = 19;
const int Face_P_Bilgot         = 20;
const int Face_P_Brutus         = 21;
const int Face_P_Cornelius      = 22;
const int Face_P_Cronos         = 23;
const int Face_P_Cutter         = 24;
const int Face_P_Delta          = 25;
const int Face_P_Dyrian         = 26;
const int Face_P_EgilEhnim      = 27;
const int Face_P_Fed            = 28;
const int Face_P_Gordon         = 29;
const int Face_P_Grom           = 30;
const int Face_P_Gunnar         = 31;
const int Face_P_Joe            = 32;
const int Face_P_Kalom          = 33;
const int Face_P_Lester         = 34;
const int Face_P_Lothar         = 35;
const int Face_P_Marcos         = 36;
const int Face_P_Marduk         = 37;
const int Face_P_Martin         = 38;
const int Face_P_Meldor         = 39;
const int Face_P_Merdarion      = 40;
const int Face_P_Mortis         = 41;
const int Face_P_Myxir          = 42;
const int Face_P_Nefarius       = 43;
const int Face_P_Neoras         = 44;
const int Face_P_Parcival       = 45;
const int Face_P_Riordian       = 46;
const int Face_P_Ruga           = 47;
const int Face_P_Sekob          = 48;
const int Face_P_Tandor         = 49;
const int Face_P_Till           = 50;
...
const int Face_W_Hum_TattooMad1  = 64;
const int Face_W_Hum_TattooMad2  = 65;
const int Face_W_Hum_TattooMad3  = 66;
const int Face_W_Hum_TattooMad4  = 67;
const int Face_W_Hum_TattooMad5  = 68;
const int Face_W_Hum_TattooMad6  = 69;
const int Face_W_Hum_TattooMad7  = 70;
const int Face_W_Hum_TattooMad8  = 71;
const int Face_W_Hum_TattooMad9  = 72;
const int Face_W_Hum_TattooMad10 = 73;
const int Face_W_Hum_TattooMad11 = 74;
const int Face_W_Hum_TattooMad12 = 75;
const int Face_W_Hum_TattooMad13 = 76;
const int Face_W_Hum_TattooMad14 = 77;
const int Face_W_Hum_TattooMad15 = 78;
const int Face_W_Hum_TattooMad16 = 79;
const int Face_W_Hum_TattooMad17 = 80;
const int Face_W_Hum_TattooMad18 = 81;
const int Face_W_Hum_TattooMad19 = 82;
const int Face_W_Hum_TattooMad20 = 83;
const int Face_W_Hum_TattooMad21 = 84;
const int Face_W_Hum_TattooMad22 = 85;
const int Face_W_Hum_TattooMad23 = 86;
const int Face_W_Hum_TattooMad24 = 87;
const int Face_W_Hum_Bald1       = 88;
const int Face_W_Hum_Bald2       = 89;
const int Face_W_Hum_Bald3       = 90;
const int Face_W_Hum_Bald4       = 91;
const int Face_W_Hum_Bald5       = 92;
const int Face_W_Hum_Bald6       = 93;
const int Face_W_Hum_Bald7       = 94;
const int Face_W_Hum_Bald8       = 95;
const int Face_W_Hum_Bald9       = 96;
const int Face_W_Hum_Bald10      = 97;
const int Face_W_Hum_Bald12      = 98;
const int Face_W_Hum_Bald13      = 99;
const int Face_W_Hum_Beard1      = 100;
const int Face_W_Hum_Beard2      = 101;
const int Face_W_Hum_Beard3      = 102;
const int Face_W_Hum_Beard4      = 103;
const int Face_W_Hum_Beard5      = 104;
const int Face_W_Hum_Beard6      = 105;
const int Face_W_Hum_Beard7      = 106;
const int Face_W_Hum_Beard8      = 107;
const int Face_W_Hum_Beard9      = 108;
const int Face_W_Hum_Beard10     = 109;
const int Face_W_Hum_Beard11     = 110;
const int Face_W_Hum_Beard12     = 111;
const int Face_W_Hum_Beard13     = 112;
const int Face_W_Hum_Beard14     = 113;
const int Face_W_Hum_Beard15     = 114;
const int Face_W_Hum_Beard16     = 115;
const int Face_W_Hum_Beard17     = 116;
const int Face_W_Hum_Beard18     = 117;
const int Face_W_Hum_Beard19     = 118;
const int Face_W_Hum_Beard20     = 119;
const int Face_W_Hum_Beard21     = 120;
const int Face_W_Hum_Beard22     = 121;
const int Face_W_Hum_Old1        = 122;
const int Face_W_Hum_Old2        = 123;
const int Face_W_Agon            = 124;
const int Face_W_Akil            = 125;
const int Face_W_Alrik           = 126;
const int Face_W_Andre           = 127;
const int Face_W_Angus           = 128;
const int Face_W_Arkhan          = 129;
const int Face_W_Arto            = 130;
const int Face_W_Babo            = 131;
const int Face_W_Baltram         = 132;
const int Face_W_Bartired        = 133;
const int Face_W_Bartok          = 134;
const int Face_W_Bengar          = 135;
const int Face_W_Bennet          = 136;
const int Face_W_Berion          = 137;
const int Face_W_Biff            = 138;
const int Face_W_Bloodwyn        = 139;
const int Face_W_Bodo            = 140;
const int Face_W_Brago           = 141;
const int Face_W_Brahim          = 142;
const int Face_W_Bromor          = 143;
const int Face_W_Bullco          = 144;
const int Face_W_Bullit          = 145;
const int Face_W_Buster          = 146;
const int Face_W_Canthar         = 147;
const int Face_W_Cedric          = 148;
const int Face_W_Cipher          = 149;
const int Face_W_Constantino     = 150;
const int Face_W_Coragon         = 151;
const int Face_W_Cord            = 152;
const int Face_W_Dar             = 153;
const int Face_W_DarkMage        = 154;
const int Face_W_Daron           = 155;
const int Face_W_DelaCroix       = 156;
const int Face_W_Dexter          = 157;
const int Face_W_Dobar           = 158;
const int Face_W_Dragomir        = 159;
const int Face_W_Drake           = 160;
const int Face_W_Drexar          = 161;
const int Face_W_Engrom          = 162;
const int Face_W_Fajeth          = 163;
const int Face_W_Farim           = 164;
const int Face_W_Farric          = 165;
const int Face_W_Fellan          = 166;
const int Face_W_Fernando        = 167;
const int Face_W_Fester          = 168;
const int Face_W_Fortuno         = 169;
const int Face_W_Gaan            = 170;
const int Face_W_Garond          = 171;
const int Face_W_Garvell         = 172;
const int Face_W_Gerold          = 173;
const int Face_W_Girion          = 174;
const int Face_W_Godar           = 175;
const int Face_W_Gomez           = 176;
const int Face_W_Gorax           = 177;
const int Face_W_Greg            = 178;
const int Face_W_Grimes          = 179;
const int Face_W_Hagen           = 180;
const int Face_W_Hakon           = 181;
const int Face_W_Halvor          = 182;
const int Face_W_Hank            = 183;
const int Face_W_Harad           = 184;
const int Face_W_Herold          = 185;
const int Face_W_Hyglas          = 186;
const int Face_W_Igaraz          = 187;
const int Face_W_Ignaz           = 188;
const int Face_W_Ingmar          = 189;
const int Face_W_Isgaroth        = 190;
const int Face_W_Jack            = 191;
const int Face_W_Jan             = 192;
const int Face_W_Jarvis          = 193;
const int Face_W_Jergan          = 194;
const int Face_W_Jesper          = 195;
const int Face_W_Jora            = 196;
const int Face_W_Jorgen          = 197;
const int Face_W_Judge           = 198;
const int Face_W_Kardif          = 199;
const int Face_W_Keroloth        = 200;
const int Face_W_Kjorn           = 201;
const int Face_W_Kurgan          = 202;
const int Face_W_Lares           = 203;
const int Face_W_Larius          = 204;
const int Face_W_Lee             = 205;
const int Face_W_Lehmar          = 206;
const int Face_W_Lobart          = 207;
const int Face_W_Lutero          = 208;
const int Face_W_Malak           = 209;
const int Face_W_Maleth          = 210;
const int Face_W_Matteo          = 211;
const int Face_W_Milten          = 212;
const int Face_W_Mist            = 213;
const int Face_W_Moe             = 214;
const int Face_W_Morgahard       = 215;
const int Face_W_Mud             = 216;
const int Face_W_Nagur           = 217;
const int Face_W_Niclas          = 218;
const int Face_W_Onar            = 219;
const int Face_W_Oric            = 220;
const int Face_W_Pablo           = 221;
const int Face_W_Parlaf          = 222;
const int Face_W_Parlan          = 223;
const int Face_W_Pepe            = 224;
const int Face_W_Pyrokar         = 225;
const int Face_W_Q               = 226;
const int Face_W_Ramirez         = 227;
const int Face_W_Rangar          = 228;
const int Face_W_Raven           = 229;
const int Face_W_Regan           = 230;
const int Face_W_Regis           = 231;
const int Face_W_Reko            = 232;
const int Face_W_Reliops         = 233;
const int Face_W_Rengaru         = 234;
const int Face_W_Rethon          = 235;
const int Face_W_Rod             = 236;
const int Face_W_Rupert          = 237;
const int Face_W_Salandril       = 238;
const int Face_W_Salazar         = 239;
const int Face_W_Scar            = 240;
const int Face_W_Sengrath        = 241;
const int Face_W_Sentenza        = 242;
const int Face_W_Sergio          = 243;
const int Face_W_Serpentes       = 244;
const int Face_W_Sinister        = 245;
const int Face_W_Skip            = 246;
const int Face_W_Sly             = 247;
const int Face_W_Sylvio          = 248;
const int Face_W_Talbin          = 249;
const int Face_W_Thorben         = 250;
const int Face_W_Torlof          = 251;
const int Face_W_Tygren          = 252;
const int Face_W_Udar            = 253;
const int Face_W_UdarEverett     = 254;
const int Face_W_Ulf             = 255;
const int Face_W_Valentino       = 256;
const int Face_W_Vino            = 257;
const int Face_W_Wambo           = 258;
const int Face_W_Wasili          = 259;
const int Face_W_Wolf            = 260;
const int Face_W_Wulfgar         = 261;
const int Face_W_Xardas          = 262;
const int Face_W_Zerrit          = 263;
const int Face_W_Zuris           = 264;
...
const int Face_L_Hum_TattooMad1 = 9;
const int Face_L_Hum_TattooMad2 = 10;
const int Face_L_Hum_TattooMad3 = 11;
const int Face_L_Hum_Bald1      = 12;
const int Face_L_Hum_Bald2      = 13;
const int Face_L_Hum_Bald3      = 14;
const int Face_L_Hum_Bald4      = 15;
const int Face_L_Hum_Bald5      = 16;
const int Face_L_Hum_Bald6      = 17;
const int Face_L_Hum_Bald7      = 18;
const int Face_L_Hum_Bald8      = 19;
const int Face_L_Hum_Bald9      = 20;
const int Face_L_Hum_Bald10     = 21;
const int Face_L_Hum_Bald11     = 22;
const int Face_L_Hum_Bald12     = 23;
const int Face_L_Hum_Beard1     = 24;
const int Face_L_Hum_BeardOld1  = 25;
const int Face_L_Hum_BeardOld2  = 26;
const int Face_L_Hum_Old1       = 27;
const int Face_L_Attila         = 28;
const int Face_L_Borka          = 29;
const int Face_L_Bosper         = 30;
const int Face_L_Carl           = 31;
const int Face_L_Diego          = 32;
const int Face_L_Engor          = 33;
const int Face_L_Garwig         = 34;
const int Face_L_Gerbrandt      = 35;
const int Face_L_Hodges         = 36;
const int Face_L_Karras         = 37;
const int Face_L_Mika           = 38;
const int Face_L_Pedro          = 39;
const int Face_L_Raoul          = 40;
const int Face_L_Rukhar         = 41;
const int Face_L_Santino        = 42;
const int Face_L_Tengron        = 43;
const int Face_L_Ulthar         = 44;
...
const int Face_B_Hum_TattooMad1 = 6;
const int Face_B_Hum_Bald1      = 7;
const int Face_B_Hum_Bald2      = 8;
const int Face_B_Hum_Bald3      = 9;
const int Face_B_Hum_Bald4      = 10;
const int Face_B_Hum_Bald5      = 11;
const int Face_B_Hum_Bald6      = 12;
const int Face_B_Hum_Bald7      = 13;
const int Face_B_Hum_Bald8      = 14;
const int Face_B_Hum_Bald9      = 15;
const int Face_B_Hum_Bald10     = 16;
const int Face_B_Abuyin         = 17;
const int Face_B_Angar          = 18;
const int Face_B_Boltan         = 19;
const int Face_B_Brian          = 20;
const int Face_B_Bronko         = 21;
const int Face_B_Cavalorn       = 22;
const int Face_B_Feros          = 23;
const int Face_B_Gestath        = 24;
const int Face_B_Gorn           = 25;
const int Face_B_Grimbald       = 26;
const int Face_B_Hokurn         = 27;
const int Face_B_Khaled         = 28;
const int Face_B_Mario          = 29;
const int Face_B_Opolos         = 30;
const int Face_B_Orlan          = 31;
const int Face_B_Peck           = 32;
const int Face_B_Randolph       = 33;
const int Face_B_Saturas        = 34;
const int Face_B_Talamon        = 35;
const int Face_B_Thorus         = 36;
const int Face_B_Vatras         = 37;
...
// Face / Pale / Babe
const int Face_P_Babe_Normal1 = 51;
const int Face_P_Babe_Normal2 = 52;
const int Face_P_Babe_Normal3 = 53;
const int Face_P_Babe_Normal4 = 54;
const int Face_P_Babe_Normal5 = 55;

// Face / White / Babe
const int Face_W_Babe_Normal1  = 265;
const int Face_W_Babe_Normal2  = 266;
const int Face_W_Babe_Normal3  = 267;
const int Face_W_Babe_Normal4  = 268;
const int Face_W_Babe_Normal5  = 269;
const int Face_W_Babe_Normal6  = 270;
const int Face_W_Babe_Normal7  = 271;
const int Face_W_Babe_Normal8  = 272;
const int Face_W_Babe_Normal9  = 273;
const int Face_W_Babe_Normal10 = 274;
const int Face_W_Babe_Normal11 = 275;
const int Face_W_Babe_Normal12 = 276;
const int Face_W_Babe_Normal13 = 277;
const int Face_W_Babe_Normal14 = 278;
const int Face_W_Babe_Normal15 = 279;
const int Face_W_Babe_Normal16 = 280;
const int Face_W_Babe_Cloth1   = 281;
const int Face_W_Babe_Cloth2   = 282;
const int Face_W_Babe_Cloth3   = 283;
const int Face_W_Babe_Cloth4   = 284;
const int Face_W_Babe_Makeup1  = 285;
const int Face_W_Babe_Makeup2  = 286;
const int Face_W_Babe_Makeup3  = 287;
const int Face_W_Cassia        = 288;
const int Face_W_Elena         = 289;
const int Face_W_Fenia         = 290;
const int Face_W_Gritta        = 291;
const int Face_W_Hanna         = 292;
const int Face_W_Hilda         = 293;
const int Face_W_Kati          = 294;
const int Face_W_Maria         = 295;
const int Face_W_Nadia         = 296;
const int Face_W_Rosi          = 297;
const int Face_W_Sagitta       = 298;
const int Face_W_Sarah         = 299;
const int Face_W_Thekla        = 300;

// Face / Latino / Babe
const int Face_L_Babe_Normal1 = 45;
const int Face_L_Babe_Normal2 = 46;
const int Face_L_Babe_Normal3 = 47;
const int Face_L_Babe_Normal4 = 48;
const int Face_L_Babe_Normal5 = 49;
const int Face_L_Babe_Normal6 = 50;
const int Face_L_Sonja        = 51;

// Face / Black / Babe
const int Face_B_Babe_Normal1 = 38;
const int Face_B_Babe_Normal2 = 39;
const int Face_B_Babe_Normal3 = 40;
const int Face_B_Babe_Normal4 = 41;
const int Face_B_Babe_Normal5 = 42;
const int Face_B_Edda         = 43;
const int Face_B_Vanja        = 44;
